    ...
    <div className ='mx-w-[1640px] mx-auto p-4' >
      <div className= ' max-h-[500px] relative'>
        ...
        <div className='absolute w-full h-full text-gray-200
         ...
         justify-center'>
          <h1 className='px-4 text-4xl sm:text-5xl md:tect-6xl lg:text-7xl font-bold text-left'>The <span className='text-orange-500'> BEST</span></h1>
          <h1 className='px-4 text-4xl sm:text-5xl md:tect-6xl lg:text-7xl font-bold text-left'> <span className='text-orange-500'>Food</span> Delivered</h1>
        </div>
